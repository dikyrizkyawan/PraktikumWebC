...
<body>
  ...
  <section class="navbar">
    ...
    <section class="deskripsi">
        <div class="polaroid">
            <img src="./img/profil1.jpg" alt="profil1" style="width:200px">
            <div class="container">
                <h3>Nama </h3>
                <p style="font-size: 17px;">Diky Siang</p>
                <h3>Jabatan</h3>
                <p style="font-size: 17px;">Pria Sejati</p>
            </div>
        </div>
        <div class="polaroid">
            <img src="./img/profil2.jpg" alt="profil2" style="width:200px">
            <div class="container">
                <h3>NAMA </h3>
                <p style="font-size: 17px;">Diky Malem</p>
                <h3>Jabatan</h3>
                <p style="font-size: 17px;">Peri a</p>
            </div>
        </div>
    </section>
  </div>
