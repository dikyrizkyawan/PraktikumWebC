...
$query = mysqli_query($koneksi, "SELECT * FROM matkul INNER JOIN user ON dosen = username where role = 'dosen' order by kode_matkul asc");

if(isset($_POST["tambahbtn"])) {
    $username = $_SESSION["username"];
    $matkul = $_POST["kode"];
    $query1 = "INSERT INTO krs VALUES ('','$username','$matkul','0') ";
    $exe = mysqli_query($koneksi, $query1);
    echo "<script>
            document.location.href = 'm_kuliah.php';
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Tambah KRS</h1>
                        <div class="card mb-4">
                            <div class="card-body">
                                <form method="POST" action="">
                                    <div class="input-group" style="width: 300px">
                                        <input class="form-control" type="text" placeholder="Kode Matkul" aria-label="Search" aria-describedby="basic-addon2" name="kode" />
                                        <div class="input-group-append">
                                            <button class="btn btn-primary" type="submit" name="tambahbtn">Tambah</button>
                                        </div>
                                    </div>
                                </form>
                                <br>
