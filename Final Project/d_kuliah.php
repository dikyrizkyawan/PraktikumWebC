...
$query = mysqli_query($koneksi, "SELECT * FROM kelas INNER JOIN matkul ON kelas.kode_matkul = matkul.kode_matkul INNER JOIN user ON matkul.dosen = user.username where username = '$username'");
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $data['kuota']?></td>
                                                <td><?= $data['status']?></td>
                                                <td><a href="edit_kelas.php?id_kelas=<?= $data['id']; ?>" class="badge badge-primary ">Edit</a></td>
                                            </tr>
                                            <?php $i++; } ?>
                                        </tbody>
                                    </table>
                        ...
                        <a class="btn btn-primary" href="d_kelastambah.php">Tambah Mata Kuliah</a>
                    </div>
                </main>
